...
async def finish_test(chat_id: int, state: FSMContext):
    ...
    result_text = (
        ...
        f"Savol va takliflar uchun @IlmNuri_admi ga yozing\n <b>Yakuniy natijalarni bilish uchun rasmiy kanalimizga qo'shiling</b> 👇"
    )
...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    if existing:
        await message.answer(
            f"Siz allaqachon ro'yxatdan o'tgansiz, Testni faqat bir marta ishlash mumkin hurmatli {existing['full_name']}!")
        return
